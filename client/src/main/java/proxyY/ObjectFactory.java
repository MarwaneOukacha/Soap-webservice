...
public class ObjectFactory {
    ...
    private final static QName _Compte_QNAME = new QName("http://WebSerbvices.com/", "compte");
    private final static QName _Conversion_QNAME = new QName("http://WebSerbvices.com/", "conversion");
    private final static QName _ConversionResponse_QNAME = new QName("http://WebSerbvices.com/", "conversionResponse");
    private final static QName _GetCompte_QNAME = new QName("http://WebSerbvices.com/", "getCompte");
    private final static QName _GetCompteResponse_QNAME = new QName("http://WebSerbvices.com/", "getCompteResponse");
     ...
     */
    @XmlElementDecl(namespace = "http://WebSerbvices.com/", name = "compte")
     ...
     */
    @XmlElementDecl(namespace = "http://WebSerbvices.com/", name = "conversion")
     ...
     */
    @XmlElementDecl(namespace = "http://WebSerbvices.com/", name = "conversionResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://WebSerbvices.com/", name = "getCompte")
     ...
     */
    @XmlElementDecl(namespace = "http://WebSerbvices.com/", name = "getCompteResponse")
